...
with tab1:
    ...
    with col1:
        ...
        st.caption("💡 팁2: 원한 전략이 도출 안되셨나요? 버튼을 다시 클릭하셔서 신규 전략을 확인하세요.")
...
def generate_strategy(api_key, name, target, details, platform, tone):
    ...
    **[중요: 검색 키워드 추출]**
    ...
    # [🔥 수정됨] 여러 모델을 순차적으로 시도하여 하나라도 걸리면 성공시키는 로직
    # 1.5-flash -> 1.5-pro -> 1.0-pro 순서로 시도
    candidate_models = [
        "gemini-1.5-flash",
        "gemini-1.5-pro",
        "gemini-pro"
